Contributing to the Netuitive PHP Client
======================================
...
### Reporting Bugs
Report bugs on [the issues page](https://github.com/Netuitive/Netuitive_PHP_Client/issues).
...
### Fixing bugs
Find bugs at [the issues page](https://github.com/Netuitive/Netuitive_PHP_Client/issues). Anything tagged with
...
Find features at [the issues page](https://github.com/Netuitive/Netuitive_PHP_Client/issues). Anything tagged
...
The Netuitive PHP Client can always use documentation (more documentation is always better!). 
...
### Submitting Feedback
File an issue at [the issues page](https://github.com/Netuitive/Netuitive_PHP_Client/issues).
